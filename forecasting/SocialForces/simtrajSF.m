function []=simtrajSF(mapb,mape,map,nped)

% simtrajSF  is a function to simulate randomtrajectory and save them in a
% specific file according to the different input:
%
% mapb : index of the first map to save 
% mape :  index of the last map to save 
%
%we then can define the number of map to simulate : mape-mapb
%
% map define the type of map to simulate:  'v'  verticale corridor
%                                          'h'  horizontal corridor
%
% nped : numbe of agent per map simulated
...
%                                             pause(0.01)
        ...
        % cd ..
        cd /scr/alexr/simtrajRdSF_Eccv1/
